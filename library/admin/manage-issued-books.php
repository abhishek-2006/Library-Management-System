                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="custom-table" id="dataTables-examples">
                                    <thead>
                                        <tr>
                                            <th>#</th>
                                            <th>Student Name</th>
...
foreach($results as $result) {       ?>                                
                                        <tr class="odd gradeX">
                                            ...
                                            ?></td>
                                            <td class="center">
                                                <a href="update-issue-bookdetails.php?rid=<?php echo htmlentities($result->rid);?>"><button class="custom-btn btn-primary-theme"><i class="fa fa-edit "></i> Edit</button> 
                                            </td>
                                        </tr>
<?php $cnt=$cnt+1;}} ?>                                   
                                    </tbody>
